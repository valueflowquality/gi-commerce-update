        ...
        $scope.logout = function() {
          ...
          return $http.get('/api/logout').then(function() {
            return Auth.logout().then(function() {
              ...
              $scope.$broadcast('giCart:paymentFailed', "The checkout logout failed, please refresh the page and try again or get in touch with us at education@valueflowquality.com");
              return $scope.pricesLoaded = true;
            });
          }, function(error) {
            console.log("The checkout logout failed", error);
